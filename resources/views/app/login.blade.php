...
<body class="bg-gradient-primary">
   ...
   <div class="container vh-100">
      ...
      <div class="row justify-content-center">
         ...
         <div class="col-xl-8 col-lg-8 col-md-9 d-flex vh-100 align-items-center">

            <div class="col-12 card o-hidden border-0 shadow-lg my-5" style="height: fit-content;">
               <div class="card-body p-0">
                  <!-- Nested Row within Card Body -->
                  <div class="p-5">
                     <div class="text-center">
                        <h1 class="h4 text-gray-900 mb-4">
                           <img src="img/vector.svg" alt="logo" class="mr-3">
                           Welcome Admin!
                        </h1>
                        @if(session('error'))
                        <p style="color: red; font-style: italic;" class="mb-0">{{session('error')}}</p>
                        <!-- ------------------ -->
                        @endif
                     </div>
                     <hr>
